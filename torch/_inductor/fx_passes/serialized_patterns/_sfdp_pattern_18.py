...
full_default_1 = CallFunction(aten.full.default, [], Ignored(), dtype=Ignored(), device=Ignored(), pin_memory=False, _users=2)
div_Tensor = CallFunction(aten.div.Tensor, view_default_2, full_default_1)
where_self = CallFunction(aten.where.self, KeywordArg('causal_mask'), full_default, div_Tensor, _users=2)
...
where_self_1 = CallFunction(aten.where.self, KeywordArg('causal_mask'), scalar_tensor_default, sub_Tensor_1)
div_Tensor_2 = CallFunction(aten.div.Tensor, where_self_1, full_default_1)
...
full_default_1 = CallFunction(aten.full.default, [], Ignored(), dtype=Ignored(), device=Ignored(), pin_memory=False, _users=2)
div_Tensor = CallFunction(aten.div.Tensor, view_default_2, full_default_1)
where_self = CallFunction(aten.where.self, KeywordArg('causal_mask'), full_default, div_Tensor)
...
where_self_1 = CallFunction(aten.where.self, KeywordArg('causal_mask'), scalar_tensor_default, convert_element_type_default_5)
div_Tensor_2 = CallFunction(aten.div.Tensor, where_self_1, full_default_1)
view_default_8 = CallFunction(aten.view.default, div_Tensor_2, Ignored(), _users=2)
permute_default_5 = CallFunction(aten.permute.default, view_default_1, Ignored())
bmm_default_3 = CallFunction(aten.bmm.default, view_default_8, permute_default_5)
